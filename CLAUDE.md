...
- **Business cards (2026-09-04, Jacob):** print-ready cards for the whole team live in
  `content/business-cards/` and are generated by `pnpm cards`
  (`scripts/generate-business-cards.mjs`, roster inline at the top). Front is the
  Crossroads card, back is the Mosaic Green Worldwide card (the holding company across
  Crossroads, Verda Studio, Kawaii Katz, Legal Leaf Market, Herbal Leaf Market, Nicotia
