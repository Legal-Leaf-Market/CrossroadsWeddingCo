...
export const CITIES: City[] = [
  {
    ...
    localNotes: [
      "Backyard weddings across Bartholomew County are our bread and butter — we bring sound built for open air, not a ballroom rig pointed at a fence.",
      ...
      "Downtown or park ceremony? We've got compact battery-powered setups for spots where power is a rumor.",
    ],
  ...
  },
  {
    ...
    localNotes: [
      "Wooded and lakeside venues around Monroe County often have zero infrastructure. We arrive self-contained: sound, power plan, backup gear.",
  ...
  },
  {
    ...
    localNotes: [
      "Hillside and cabin venues mean winding load-ins and no house sound. We scout the setup in advance, so the day of, we just appear.",
