...
export type City = {
  /** Venue is past ~60 min of Columbus, so the travel surcharge applies. */
...
export const CITIES: City[] = [
  ...
  },
  {
    ...
    localNotes: [
      ...
      "IU crowd on the guest list? We read the room between generations, so the dance floor stays full without anyone's grandmother fleeing.",
  ...
  },
  {
    ...
    intro:
      "Crossing the river doesn't change the number. Louisville couples get the same flat-rate DJ, MC, and day-of coordination we run in Indiana, bourbon-country venue and Highlands backyard alike.",
    localNotes: [
  ...
  },
  {
    ...
    localNotes: [
      ...
      "Northern Kentucky venues like Covington and Newport are absolutely in range. The state line is not a surcharge.",
    ],
    hasTravelSurcharge: true,
    travelNote:
      "Just under two hours from Columbus, at the edge of our range. A $100–$150 travel surcharge applies, quoted up front, paid directly to the crew driving.",
  },
];
